...
def plot_functions(x,y,func1,func2,func3,func4):
    ...
    plt.plot(x, predict4, label = "11 layers")
    plt.plot(x, predict3, label = "7 layers")
    plt.plot(x, predict2, label = "4 layers")
...
def plot_loss(model1,model2,model3,model4):
    ...
    plt.plot(history4,label = "11 layers")
    plt.plot(history1,label = "2 layers")
    plt.plot(history3,label = '7 layers')
    plt.plot(history2,label = "4 layers")

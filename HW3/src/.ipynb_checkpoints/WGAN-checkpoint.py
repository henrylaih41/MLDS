...
import cv2
class DCGAN():
    def __init__(self, args, noise_dim=100, batch_size=512, lr=0.0002, beta1=0.5, scale=5.0):
    ...
    def build_model(self,z,real_image):
        def build_generator():
            ...
            return gen_image
        ### Add batch_norm at discriminator
        def build_discriminator(image,reuse=False):
            ...
            with tf.variable_scope("discriminator") as scope:
                ...
                ### batch_norm here will cause discriminator to fail.
        ...
        self.d_opt = tf.train.AdamOptimizer(self.lr, beta1=self.beta1).minimize(self.d_loss, var_list=d_vars)
...
parser.add_argument('--name', type=str, default="2modifiedWGAN")
parser.add_argument('--save_path', type=str, default="../w2model/")
parser.add_argument('--image_save_path', type=str, default="/modified/")
